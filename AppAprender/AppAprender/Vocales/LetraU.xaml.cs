...
namespace Vocales
{
    public partial class LetraU : PhoneApplicationPage
    {
        ...
        void LetraU_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            recurso.reporducirSonido("/Sonidos/Voces/LetraU.mp3");
        ...
        {
            NavigationService.Navigate(new Uri("/../Vocales/Letras/LetraU.xaml", UriKind.Relative));
        }
        protected override void OnNavigatedTo(System.Windows.Navigation.NavigationEventArgs e)
        {
            if (e.Uri.ToString() != "/Vocales/LetraU.xaml")
            {
